package com.teamwizardry.mirror.reflection.utils

import kotlin.reflect.KProperty

interface LazyOrSet<T>: Lazy<T> {
...
fun <T> lazyOrSet(initializer: () -> T): LazyOrSet<T> = SynchronizedLazyOrSetImpl(initializer)
