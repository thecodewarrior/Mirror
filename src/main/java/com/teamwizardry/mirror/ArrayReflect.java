...
public class ArrayReflect {
    ...
    public static void setByte(Object array, int index, byte b) {
        ...
        else if (array instanceof short[]) ((short[]) array)[index] = b;
        else if (array instanceof int[]) ((int[]) array)[index] = b;
        else if (array instanceof long[]) ((long[]) array)[index] = b;
        else if (array instanceof float[]) ((float[]) array)[index] = b;
        else if (array instanceof double[]) ((double[]) array)[index] = b;
        else
            throw badArray(array);
    }
    ...
    public static void setChar(Object array, int index, char c) {
        ...
        else if (array instanceof int[]) ((int[]) array)[index] = c;
        else if (array instanceof long[]) ((long[]) array)[index] = c;
        else if (array instanceof float[]) ((float[]) array)[index] = c;
        else if (array instanceof double[]) ((double[]) array)[index] = c;
        else
            throw badArray(array);
    }
    ...
    public static void setShort(Object array, int index, short s) {
        ...
        else if (array instanceof int[]) ((int[]) array)[index] = s;
        else if (array instanceof long[]) ((long[]) array)[index] = s;
        else if (array instanceof float[]) ((float[]) array)[index] = s;
        else if (array instanceof double[]) ((double[]) array)[index] = s;
        else
            throw badArray(array);
    }
    ...
    public static void setInt(Object array, int index, int i) {
        ...
        else if (array instanceof float[]) ((float[]) array)[index] = i;
    ...
    public static void setLong(Object array, int index, long l) {
        ...
        else if (array instanceof float[]) ((float[]) array)[index] = l;
        else if (array instanceof double[]) ((double[]) array)[index] = l;
        else
            throw badArray(array);
    }
    ...
    public static void setFloat(Object array, int index, float f) {
        ...
        else if (array instanceof double[]) ((double[]) array)[index] = f;
        else
            throw badArray(array);
    }
    ...
    public static void set(Object array, int index, Object value) {
        ...
        } else if (value instanceof Boolean) setBoolean(array, index, (boolean) value);
        else if (value instanceof Byte) setByte(array, index, (byte) value);
        else if (value instanceof Short) setShort(array, index, (short) value);
        else if (value instanceof Character) setChar(array, index, (char) value);
        else if (value instanceof Integer) setInt(array, index, (int) value);
        else if (value instanceof Long) setLong(array, index, (long) value);
        else if (value instanceof Float) setFloat(array, index, (float) value);
        else if (value instanceof Double) setDouble(array, index, (double) value);
        else
            throw badArray(array);
    }
